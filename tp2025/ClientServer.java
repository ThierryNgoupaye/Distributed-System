...
public class ClientServer extends LC0_Algorithm {
    ...
    protected void onStarCenter() {
        ...
        this.putProperty("Affichage", this.displayNeighborStateList(this.counter_client, this.counter_server), SimulationConstants.PropertyStatus.DISPLAYED);
    }


    private String displayNeighborStateList(int counter_client, int counter_server){
